...
{
    // la función debería devolver el máximo de estos tres, pero si datos==0
    // entonces datos no se tiene en cuenta, pero si datos != 0 es tcp el que
    // no se tiene en cuenta ya que no se vigila para admitir más clientes
