...
// La implementación de la lista de clientes es muy ineficiente. Lo correcto
// sería usar una tabla hash o un diccionario, pero el C estándar no incluye
// este tipo de datos, y se sale de los objetivos de la asignatura implementar
// este tipo y todas sus operaciones, de modo que se opta por una solución
// mucho más simple aunque inadecuada: un array de tamaño fijo que contiene
// punteros a las estructuras cliente, y búsquedas ineficientes recorriendo
// el array completo.
...
// no ocurrirán normalmente durante las sesiones prácticas.
{
    ...
    // Copiar los parámetros recibidos en el nuevo cliente
    strcpy(c->nick, nick);
...
// del cliene encontrado, y la función retorna 0
// Si no se encuentra, la función retorna -1 y el contenido de la
...
void ejecutar_comando(int sock)
{
    ...
    case JOIN_CMD:
        ...
        // DEBUG: imprimimos esa información
    ...
    case QUERY_CMD:
        ...
        printf("Solicitamos datos del nick |%s|\n", nick);
        // Buscar el nick
